...
%falar do background subtraction
%falar das transformacoes morfologicas

\section{Methodology}

\subsection{Dataset}
\subsection{}
%explicar como implementamos, mostrar codigos ou pseudocodigos

\subsection{Result display}
%mostrar um heatmap feito
